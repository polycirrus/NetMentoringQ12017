...
namespace Sample03
{
    ...
    public class E3SProviderTests
    {
        ...
        [TestMethod]
        public void WithProvider_MemberEqualsConstant()
        {
        ...
        [TestMethod]
        public void WithProvider_ConstantEqualsMember()
        {
            var employees = new E3SEntitySet<EmployeeEntity>(ConfigurationManager.AppSettings["user"], ConfigurationManager.AppSettings["password"]);
        ...
        public void WithProvider_Contains()
        {
            ...
            foreach (var emp in employees.Where(e => e.workstation.Contains("RUIZHW02")))
            {
                Console.WriteLine("{0} {1}", emp.nativename, emp.startworkdate);
            }
        }
        ...
        public void WithProvider_And()
        {
            ...
            foreach (var emp in employees.Where(e => e.workstation.StartsWith("EPRUIZHW02") && e.nativename.EndsWith("ов")))
            {
                Console.WriteLine("{0} {1}", emp.nativename, emp.startworkdate);
            }
        }
